...
public class ChessMatch {
	...
	//retorna uma matriz de pecas correspondente a partida
	...
	private void validateTargetPosition(Position source, Position tatget) {
		if (!board.piece(source).possibleMove(tatget)) {
